...
const SearchResults = ({ results, pagination, loading, query, onPageChange }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {results.map((document) => (
          <div key={document._id} className="bg-white rounded-lg shadow-sm border p-6 hover:shadow-md transition-shadow">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between text-sm text-gray-500">
                  ...
                  <div className="flex items-center space-x-2">
                    <Heart size={14} className={document.metrics?.likes?.length > 0 ? 'text-red-500' : ''} />
